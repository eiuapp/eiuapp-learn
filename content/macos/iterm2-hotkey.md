---
title: "Iterm2 Hotkey"
date: 2018-06-13T16:15:59+08:00
draft: false
tags: ["iterm2", "hotkey"]
categories: ["iterm2"]
subtitle: "iTerm2 快捷键大全"
descriptions: ""
bigimg:
---
...
### 设置快捷键
这一步很简单，定位到 [Preferences - Keys - Hotkey]，这里有两个选项
- 第一个为设置全局快捷键，在 iTerm 启动的前提下，使用该快捷键（比如，这里我设置为`F12`）可显示或隐藏窗口。
- 第二个指定新窗口使用哪个 Profile，这里就指定为在 Step1 中设置了 WIndow 的那个即可，勾选这个选项能获得显示／隐藏窗口时淡入淡出的技能。
